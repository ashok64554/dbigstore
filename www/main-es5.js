...
var map = {
	"./add-product/product-details/product-details.module": [
		"./src/app/add-product/product-details/product-details.module.ts",
		"common",
		"add-product-product-details-product-details-module"
	],
	"./add-product/product-image/product-image.module": [
		"./src/app/add-product/product-image/product-image.module.ts",
		"default~add-product-product-image-product-image-module~login-login-module",
		"common",
		"add-product-product-image-product-image-module"
	],
	"./login/login.module": [
...
var routes = [
    ...
    { path: 'product-details/:upload',
        resolve: {
            special: _resolver_data_resolver_service__WEBPACK_IMPORTED_MODULE_3__["DataResolverService"]
        },
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
                _angular_fire__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].config),
...
var DataResolverService = /** @class */ (function () {
    ...
    DataResolverService.prototype.resolve = function (route) {
        var id = route.paramMap.get('upload');
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.selectPictureCamera = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var sourceType, options;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                sourceType = 1;
                options = {
                ...
                return [2 /*return*/, this.camera.getPicture(options).then(function (imageUri) {
                        _this.originalImage = '';
                        _this.allImageToShow.push('data:image/jpeg;base64,' + imageUri);
                        return _this.originalImage = 'data:image/jpeg;base64,' + imageUri;
                    })];
            });
        });
    };
    DataService.prototype.selectPictureGallery = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var sourceType, options;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                return [2 /*return*/, this.camera.getPicture(options).then(function (imageGUri) {
                        _this.originalImage = '';
                        _this.allImageToShow.push('data:image/jpeg;base64,' + imageGUri);
                        return _this.originalImage = 'data:image/jpeg;base64,' + imageGUri;
                    })];
            });
        });
    };
...
var environment = {
    production: false,
    config: {
        apiKey: "AIzaSyChEh-YODM1D_wts8BNT0FDTOqlE4dnDJg",
        authDomain: "dbigstore.firebaseapp.com",
        databaseURL: "https://dbigstore.firebaseio.com",
        projectId: "dbigstore",
        storageBucket: "dbigstore.appspot.com",
        messagingSenderId: "793170501585",
    }
};
/*
...
module.exports = __webpack_require__(/*! D:\newrise_ionic_projects\mobile-app\src\main.ts */"./src/main.ts");
