...
var CrudService = /** @class */ (function () {
    function CrudService(firestore, storage, database) {
        this.firestore = firestore;
        this.storage = storage;
        this.database = database;
    }
    CrudService.prototype.create_NewProduct = function (record) {
        return this.firestore.collection('Products').add(record);
    };
    CrudService.prototype.add_subcollection = function (recordID, record) {
